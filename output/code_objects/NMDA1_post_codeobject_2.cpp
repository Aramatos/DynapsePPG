#include "code_objects/NMDA1_post_codeobject_2.h"
#include "objects.h"
...
void _run_NMDA1_post_codeobject_2()
{
...
const size_t _num_synaptic_pre = _dynamic_array_NMDA1__synaptic_pre.size();
    ...
    {
    std::vector<int> *_spiking_synapses = NMDA1_post.peek();
...
void _debugmsg_NMDA1_post_codeobject_2()
{
    using namespace brian;

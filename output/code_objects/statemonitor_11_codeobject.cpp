...
const size_t _num_postsynaptic_idx = _dynamic_array_GABA_B9__synaptic_post.size();
    ...
    _dynamic_array_statemonitor_11_I_syn_gaba_b.resize(_new_size, _num_indices);
    ...
    for (int _i = 0; _i < (int)_num_indices; _i++)
    {
        ...
        _dynamic_array_statemonitor_11_I_syn_gaba_b(_new_size-1, _i) = _to_record_I_syn_gaba_b;
    }

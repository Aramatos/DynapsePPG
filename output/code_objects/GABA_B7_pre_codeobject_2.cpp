#include "code_objects/GABA_B7_pre_codeobject_2.h"
#include "objects.h"
...
void _run_GABA_B7_pre_codeobject_2()
{
...
double* const _array_GABA_B7_weight = _dynamic_array_GABA_B7_weight.empty()? 0 : &_dynamic_array_GABA_B7_weight[0];
const size_t _numweight = _dynamic_array_GABA_B7_weight.size();
...
const size_t _num_postsynaptic_idx = _dynamic_array_GABA_B7__synaptic_post.size();
    ///// POINTERS ////////////
    ...
    double* __restrict  _ptr_array_GABA_B7_weight = _array_GABA_B7_weight;
    ...
    {
    std::vector<int> *_spiking_synapses = GABA_B7_pre.peek();
    ...
    
    {
            ...
            _spiking_synapse_idx++)
        {
            ...
            const int32_t _postsynaptic_idx = _ptr_array_GABA_B7__synaptic_post[_idx];
            double I_syn_gaba_b_post = _ptr_array_Core_1_I_syn_gaba_b[_postsynaptic_idx];
            const double weight = _ptr_array_GABA_B7_weight[_idx];
...
void _debugmsg_GABA_B7_pre_codeobject_2()
{
    using namespace brian;
    std::cout << "Number of synapses: " << _dynamic_array_GABA_B7__synaptic_pre.size() << endl;
}

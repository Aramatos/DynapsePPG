...
const size_t _num_sub_idx = 2;
    ...
    int32_t*   _ptr_array_statemonitor_14__indices = _array_statemonitor_14__indices;
    ...
    _dynamic_array_statemonitor_14_Imem.resize(_new_size, _num_indices);
    ...
    for (int _i = 0; _i < (int)_num_indices; _i++)
    {
        ...
        _dynamic_array_statemonitor_14_Imem(_new_size-1, _i) = _to_record_Imem;
    }

...
const size_t _num_postsynaptic_idx = _dynamic_array_NMDA0__synaptic_post.size();
    ...
    double* __restrict  _ptr_array_Core_0_I_wo_syn_nmda = _array_Core_0_I_wo_syn_nmda;
    ...
    
    {
            ...
            _spiking_synapse_idx++)
        {
            ...
            const double I_wo_syn_nmda_post = _ptr_array_Core_0_I_wo_syn_nmda[_postsynaptic_idx];
            double I_syn_nmda_post = _ptr_array_Core_0_I_syn_nmda[_postsynaptic_idx];
            const double I_g_syn_nmda_post = _ptr_array_Core_0_I_g_syn_nmda[_postsynaptic_idx];
            const double I_tau_syn_nmda_post = _ptr_array_Core_0_I_tau_syn_nmda[_postsynaptic_idx];
            ...
            _ptr_array_Core_0_I_syn_nmda[_postsynaptic_idx] = I_syn_nmda_post;
